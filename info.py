...
BOT_TOKEN = environ.get('BOT_TOKEN', "7260740274:AAGI9WDNYNenneM1SaywrsfVRc-hZoCIAgs")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002055639714').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001394587233') # give your force subscribe channel id here else leave it blank
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://aaroha:aaroha@cluster0.pnzoc.mongodb.net/?retryWrites=true&w=majority") # Necessary If clone mode is true
