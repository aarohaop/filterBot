...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5733041985').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://aaroha:<password>@cluster0.tr4jtap.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
