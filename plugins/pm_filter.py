...
async def pm_text(bot, message):
    ...
    if PM_SEARCH == True:
        ...
        await message.reply_text(text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/premium_movies_request_group>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/premium_movies_request_group")]]))
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @kingvj01
        ...
        buttons = [[
            InlineKeyboardButton('Movies Gʀᴏᴜᴘ', url="https://t.me/premium_movies_request_group"),
            InlineKeyboardButton('Movies Channel', url="https://t.me/NetflixVilla_India")
        ],[
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/Filmy_boyy")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, name, msg, reply_msg, ai_search, spoll=False):
    ...
    if imdb:
        ...
        if settings["button"]:
            cap = f"<b><b>HEY {query.from_user.mention}🍿\n\n📁The Results Fᴏʀ Your Search ☞ {search}\n\n</b>"
        else:
            cap = f"<b><b>HEY {query.from_user.mention}🍿\n\n📁The Results Fᴏʀ Your Search ☞ {search}\n\n</b>"
